...
def	stop_machine():
	...
	return executeOperation(lambda: myAzWrapper.azVmChange(request.remote_addr, azWrapper.VmAction.STOP, rg, vm))
...
def	start_machine():
	...
	return executeOperation(lambda: myAzWrapper.azVmChange(request.remote_addr, azWrapper.VmAction.START, rg, vm))
